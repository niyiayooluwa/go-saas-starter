...
import (
	...
	authhandler "go-saas-starter/internal/auth/handler"
	"go-saas-starter/internal/auth/repository"
	"go-saas-starter/internal/auth/service"
	"go-saas-starter/internal/config"
	db "go-saas-starter/internal/db/generated"
	"go-saas-starter/internal/httpserver"
	"go-saas-starter/internal/mailer"

	_ "go-saas-starter/docs" // generated by `swag init`, provides the swagger.json the router serves
)
